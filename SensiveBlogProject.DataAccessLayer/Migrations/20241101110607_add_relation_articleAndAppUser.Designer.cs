...
namespace SensiveBlogProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20241101110607_add_relation_articleAndAppUser")]
    partial class add_relation_articleAndAppUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SensiveBlogProject.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SensiveBlogProject.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SensiveBlogProject.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
